...
if __name__ == '__main__':
    # 駅名
    station_name = ["新宿", "御茶ノ水", "神田", "秋葉原"]

    # 路線図（同一の駅は0、直接つながっていない駅は-1）
    route_map = [
    [ 0, 10, 12, 19], # [0]新宿から他の駅までの時間
    [10, 0, -1, 3], # [1]御茶ノ水から他の駅までの時間
    [12, -1, 0, 2], # [2]神田から他の駅までの時間
    [19, 3, 2, 0] # [3]秋葉原から他の駅までの時間
    ]

    # [0]新宿から[3]秋葉原までの最短経路と時間を求める
    start = 0
    goal = 3
